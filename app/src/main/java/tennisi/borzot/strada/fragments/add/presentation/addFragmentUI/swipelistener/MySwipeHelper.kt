...
abstract class MySwipeHelper(context: Context, private val recyclerView: RecyclerView, private var buttonWidth: Int) :
    ...
    private fun drawButton(c: Canvas, itemView: View, buffer: MutableList<MyButton>, pos: Int, translationX: Float) {
        ...
        for (button in buffer) {
            ...
            button.onDraw(c, RectF(left, itemView.top.toFloat(), right-20f, itemView.bottom.toFloat()), pos)
            right = left
        }
    }
}