...
class SettingsListAdapter : RecyclerView.Adapter<SettingsItemViewHolder>() {
    ...
    val list = listOf(
        ...
        SettingsItem(
            R.drawable.ic_settings_notification_24, "Notification", "Turn notifications\n" +
                    "on or off"
        ),
        SettingsItem(
            R.drawable.ic_settings_service_24, "Service", "Internal application\n" +
                    "setup"
        ),
        SettingsItem(
            R.drawable.ic_settings_unit_24, "Unit", "Speed unit,\n" +
                    "km/h or mph"
        ),
        SettingsItem(
            R.drawable.ic_settings_appearance_24, "Appearance", "Light, dark,\n" +
                    "system themes"
        )
